...
#define kDefaultTabsViewBackgroundColor [UIColor colorWithRed:6/256.0 green:10/256.0 blue:44/256.0 alpha:1]
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        self.backgroundColor = [UIColor colorWithRed:6/256.0 green:10/256.0 blue:44/256.0 alpha:1];
...
- (void)viewWillLayoutSubviews {
    ...
    frame.origin.x = 0.0;
    frame.origin.y = self.tabLocation ?  : self.view.frame.size.height - self.tabHeight;
